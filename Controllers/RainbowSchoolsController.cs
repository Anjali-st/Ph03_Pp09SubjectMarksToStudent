...
namespace WebAppliPracticePro_09.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class RainbowSchoolsController : ControllerBase
    {
        private readonly PracticePro_09DbContext _context;

        public RainbowSchoolsController(PracticePro_09DbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<RainbowSchool>> PostRainbowSchool(RainbowSchool rainbowSchool)
        {
          if (_context.RainbowSchool == null)
          {
              return Problem("Entity set 'PracticePro_09DbContext.RainbowSchool'  is null.");
          }
